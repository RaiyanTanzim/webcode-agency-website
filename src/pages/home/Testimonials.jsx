            ...
            >
              <div className="md:w-1/2 bg-white rounded-md shadow md:p-8 p-4">
                ...
                <p className="text-gray-600 italic mb-4 md:w-3/5 mx-auto">
                  ...
                  faucibus risus velit diam. Non, massa ut a arcu, fermentum,
                  vel interdum."
                </p>
              ...
              <div className="md:w-1/2 bg-white rounded-md shadow md:p-8 p-4">
                ...
                <p className="text-gray-600 italic mb-4 md:w-3/5 mx-auto">
                  ...
                  eum facilis, doloremque possimus maiores beatae quas, rerum
                  cum quaerat, sunt odio ad? Officia sequi amet alias dolor
                  natus at quod facere corrupti. Consequuntur doloribus
            ...
            >
              <div className="md:w-1/2 bg-white rounded-md shadow md:p-8 p-4">
                ...
                <p className="text-gray-600 italic mb-4 md:w-3/5 mx-auto">
                  ...
                  Repellendus dolores odit, fugit laboriosam eius temporibus
                  nisi consequuntur similique doloremque impedit ab ullam
                  corrupti itaque ducimus."
                </p>
              ...
              <div className="md:w-1/2 bg-white rounded-md shadow md:p-8 p-4">
                ...
                />
                <p className="text-gray-600 italic mb-4 md:w-3/5 mx-auto">
                  "Reiciendis obcaecati. Illum distinctio impedit qui dolorem
                  possimus atque nobis in molestiae eligendi molestias officia
                  sint omnis sequi, cupiditate tempore eveniet alias dolorum
                  deserunt expedita vero officiis quis! Impedit, distinctio.
                  Qui."
                </p>
